...
describe("POST /api/v1/users", () => {
  describe("Anonumous user", () => {
    test("With unique and valid data", async () => {
      ...
      const userInDatabase = await user.findOneByUsername("estevamponte");
  ...
  describe("Default user", () => {
    test("With unique and valid data", async () => {
      ...
      const userResponse2 = await fetch(`${webserver.origin}/api/v1/users`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      expect(userResponse2Body).toEqual({
        name: "ForbiddenError",
